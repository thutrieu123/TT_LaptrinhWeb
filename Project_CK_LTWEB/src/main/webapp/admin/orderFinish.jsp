					...
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title text-uppercase text-center mb-3">
								<fmt:message key="order.finish" bundle="${lang }"></fmt:message>
							</h3>
									...
									<tbody>
										<c:forEach var="o" items="${listOrder}">
											<tr>
												...
												<td>${o.userName }</td>
												<td>${o.date }</td>
												<td><a href ="/Project_CK_LTWEB/order?action=detail&orderId=${o.orderId }&previous=finish"  class = "btn btn-primary"><i class="ti-eye" title= "<fmt:message key="order.detail"
													bundle="${lang }"></fmt:message>"></i></a></td>
												<td><span class="badge badge-success"><fmt:message
															key="order.finishName" bundle="${lang }"></fmt:message></span></td>
