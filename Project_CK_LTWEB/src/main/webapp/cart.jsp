...
<body>
	...
	<div class="container">
		...
		<table id="cart" class="table table-hover table-condensed">
				...
				<form method="POST" action="CartController">
					<tbody>
						<tr>
							<td data-th="Product">
								<div class="row">
									...
									<div class="col-sm-2 hidden-xs">
										<img src="${cartItem.image}" class="img-responsive"	width="100" height="100">
									</div>
							...
							<a href="CartController?action=update&quan=1&stt=${counter.count}&cart_pro_id=${cartItem.id}" class="btn btn-in_decrement">
								<i class="ti-plus"></i>
							</a>
			...
			<strong>TỔNG:${cart.formatTotal()} VNĐ.</strong></td>
			</tfoot>
		</table>
	</div>
