...
public class Blog extends AbBean implements Serializable {
	int id;
	int level;
	String src;
	int userId;
	...
	public Blog( int level,int userId, String src,  String content, Date creatAt, int status) {
        this.level = level;
        this.src = src;
        this.userId = userId;
	...
	public Blog( int level,int userId, String src,  String content,int status) {
        this.level = level;
        this.src = src;
        this.userId = userId;
        this.content = content;
...
//				"INSERT INTO log(`level`, `user`, src, content, createAt, `status`)  VALUES(?,?,?,?,NOW(),?)",
